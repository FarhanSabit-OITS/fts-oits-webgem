    ...
    <section id={SectionId.HOME} className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden bg-slate-50 dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl">
          {/* Badge */}
          <div className={`inline-flex items-center gap-3 px-6 py-3 rounded-full bg-blue-50/90 dark:bg-blue-900/40 backdrop-blur-md text-blue-700 dark:text-blue-300 text-[11px] font-black uppercase tracking-[0.2em] mb-10 shadow-sm border border-blue-100 dark:border-blue-800/50 transition-all duration-1000 ease-[cubic-bezier(0.23,1,0.32,1)] ${isVisible ? 'opacity-100 translate-y-0 scale-100' : 'opacity-0 translate-y-8 scale-95'}`}>
