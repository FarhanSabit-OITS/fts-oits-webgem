  ...
  return (
    <section ref={heroRef} id={SectionId.HOME} className="relative pt-32 pb-20 md:pt-48 md:pb-32 overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="absolute top-0 left-0 w-full h-full -z-10 overflow-hidden pointer-events-none">
        ...
        {/* Parallax Layer 1: Blurred Background Image */}
        <div 
      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="flex-1 space-y-8 text-center lg:text-left relative z-10">
            ...
            <div className={`flex flex-col sm:flex-row items-center gap-4 justify-center lg:justify-start transition-all duration-1000 delay-400 ease-out transform ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'}`}>
              <Button 
                size="lg" 
                variant="primary"
                aria-label="Request a demo and start your journey"
          ...
          <div className={`flex-1 w-full max-w-xl lg:max-w-none transition-all duration-1000 delay-300 ease-out transform ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 translate-x-12'}`}>
            <div className="relative">
              ...
              <div className="absolute top-2 -right-2 w-full h-full bg-slate-800/10 dark:bg-slate-900/50 rounded-2xl -rotate-1 opacity-10" aria-hidden="true"></div>
              ...
              <div className="relative bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-2xl shadow-2xl overflow-hidden aspect-[4/3] group">
                <img 
                  ...
                  alt="Interface preview of our custom software solutions"
                  loading="lazy"
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 glass-panel rounded-xl shadow-lg transform transition-all duration-500 translate-y-2 group-hover:translate-y-0">
                  <div className="flex items-center gap-4">
                    <div className="w-10 h-10 rounded-full bg-blue-100 dark:bg-blue-900 flex items-center justify-center text-blue-600 dark:text-blue-300" aria-hidden="true">
                    ...
                    <div className="ml-auto text-green-600 dark:text-green-400 font-bold text-sm" aria-label="Completion rate increased by 24 percent">+24%</div>
                  </div>
                </div>
              </div>
            </div>
