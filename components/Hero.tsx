...
export const Hero: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Canvas Animation - Robust Fallback for Lottie
    ...
    <section id={SectionId.HOME} className="relative min-h-screen flex items-center pt-24 pb-12 overflow-hidden bg-white dark:bg-slate-950 transition-colors duration-500">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="max-w-5xl">
          <div className="inline-flex items-center gap-3 px-5 py-2.5 rounded-full bg-blue-50/90 dark:bg-blue-900/40 backdrop-blur-sm text-blue-700 dark:text-blue-300 text-xs font-black uppercase tracking-widest mb-10 shadow-sm border border-blue-100 dark:border-blue-800/50 animate-in fade-in slide-in-from-bottom-4 duration-[1000ms] ease-[cubic-bezier(0.23,1,0.32,1)]">
          ...
          <h1 className="text-glow text-6xl md:text-8xl lg:text-9xl font-black text-slate-950 dark:text-white leading-[0.85] tracking-tighter mb-10 flex flex-wrap gap-x-4 drop-shadow-md">
            {TAGLINE.split(' ').map((word, i) => (
              <span 
                key={i} 
                className={`${i < 2 ? 'text-slate-950 dark:text-white' : 'text-transparent bg-clip-text bg-gradient-to-br from-blue-700 to-indigo-700 dark:from-blue-400 dark:to-indigo-300 drop-shadow-sm'} inline-block animate-in fade-in slide-in-from-bottom-12 duration-[1400ms] ease-[cubic-bezier(0.23,1,0.32,1)] transform-gpu`}
          ...
          <div className="relative mb-14 animate-in fade-in slide-in-from-bottom-10 duration-[1400ms] delay-[800ms] ease-[cubic-bezier(0.23,1,0.32,1)]">
            <div className="absolute -left-6 top-1 bottom-1 w-1.5 bg-gradient-to-b from-blue-600 to-indigo-600 rounded-full" />
            <p className="text-xl md:text-3xl text-slate-800 dark:text-slate-200 font-bold max-w-3xl leading-[1.35] pl-8 drop-shadow-sm text-glow">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-6 animate-in fade-in slide-in-from-bottom-12 duration-[1400ms] delay-[1100ms] ease-[cubic-bezier(0.23,1,0.32,1)]">
            <Button 
              variant="primary" 
              size="lg" 
          ...
          <div className="mt-24 pt-12 border-t border-slate-200 dark:border-slate-800 grid grid-cols-2 md:grid-cols-4 gap-12 animate-in fade-in duration-[1800ms] delay-[1300ms] ease-[cubic-bezier(0.23,1,0.32,1)]">
             {[
               ...
               <div key={i} className="group cursor-default animate-in fade-in slide-in-from-bottom-8 duration-[1200ms] ease-out" style={{ animationDelay: `${1400 + (i * 150)}ms` }}>
