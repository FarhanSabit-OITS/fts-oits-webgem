...
export const Button: React.FC<ButtonProps> = ({ 
  ...
  const variants = {
    primary: "bg-slate-950 text-white hover:bg-slate-800 hover:scale-[1.05] hover:shadow-[0_20px_40px_-10px_rgba(0,0,0,0.5)] dark:bg-blue-600 dark:hover:bg-blue-500 dark:hover:shadow-[0_20px_40px_-10px_rgba(37,99,235,0.6)] border border-transparent shadow-lg",
