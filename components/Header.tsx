    ...
    >
      <div className="container mx-auto px-6 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-2" aria-label="Desktop primary navigation">
          ...
          <div className="ml-2">
            <Button variant="primary" size="sm" onClick={scrollToContact} aria-label="Request a custom software project demo and consultation">
              Request Demo
            </Button>
          </div>
        </nav>
      ...
      {isMobileMenuOpen && (
        ...
        >
          <nav className="flex flex-col gap-2" aria-label="Mobile primary navigation">
            ...
            <Button className="w-full mt-4" onClick={scrollToContact} aria-label="Book a free consultation and personalized software demo">
              Request Demo
            </Button>
          </nav>
        </div>
